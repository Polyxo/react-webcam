	...
	var Webcam = (function (_Component) {
	  ...
	  _createClass(Webcam, null, [{
	    ...
	    value: {
	      ...
	      selectVideoSource: _react.PropTypes.func,
	      selectAudioSource: _react.PropTypes.func
	    },
	    enumerable: true
	  }, {
	    ...
	    if (this.props.audioSource && this.props.videoSource) {
	      ...
	      if ('mediaDevices' in navigator) {
	        navigator.mediaDevices.enumerateDevices().then(function (devices) {
	          ...
	          if (_this.props.selectVideoSource) videoSource = _this.props.selectVideoSource(devices);

	          if (_this.props.selectAudioSource) audioSource = _this.props.selectAudioSource(devices);
